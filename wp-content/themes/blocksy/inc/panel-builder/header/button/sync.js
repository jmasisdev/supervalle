	...
	variableDescriptors => {
		variableDescriptors['button'] = ({ itemId }) => ({
			...
			transparentHeaderButtonFontColor: [
				{
					selector: `[data-transparent-row="yes"] [data-id="${itemId}"] .ct-button`,
				...
				{
					selector: `[data-transparent-row="yes"] [data-id="${itemId}"] .ct-button-ghost`,
			...
			stickyHeaderButtonFontColor: [
				{
					selector: `[data-sticky*="yes"] [data-id="${itemId}"] .ct-button`,
					variable: 'buttonTextInitialColor',
					type: 'color:default',
					responsive: true
				},
				...
				{
					selector: `[data-sticky*="yes"] [data-id="${itemId}"] .ct-button-ghost`,
					variable: 'buttonTextInitialColor',
					type: 'color:default_2',
					responsive: true
				},
