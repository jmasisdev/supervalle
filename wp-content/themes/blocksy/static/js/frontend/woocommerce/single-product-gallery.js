	...
	const renderPhotoswipe = ({ onlyZoom = false } = {}) => {
			...
			if (
				...
				el.addEventListener('click', e => {
					...
					let pills = document.querySelector(
						'.product.type-product .flexy-pills'
					)
		...
		if (maybeTrigger) {
			maybeTrigger.addEventListener('click', e => {
				...
				if (
					document.querySelector(
						'.product.type-product .ct-product-view > .ct-image-container'
					)
				) {
					window.PhotoSwipe &&
						openPhotoswipeFor(
				...
				if (
					document.querySelector(
						'.product.type-product .flexy-items .ct-image-container'
					)
				) {
					let pills = document.querySelector(
						'.product.type-product .flexy-pills'
					...
					window.PhotoSwipe &&
						openPhotoswipeFor(
							document.querySelector(
								'.product.type-product .flexy-items'
